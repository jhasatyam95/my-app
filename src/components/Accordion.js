...
export default function Accordion() {
    ...
    const [style,toggleStyle] = useState({
        color:'white',
        backgroundColor:"black"
    })

    const [textmode,changeTextMode] = useState('Light Mode');
  ...
  return (
    <div className='container mt-5'>
        ...
        <button className='btn btn-primary my-5' onClick={changeColor}>Change to {textmode}</button>
    </div>
  )
}
